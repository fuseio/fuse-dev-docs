...
[Any entity that is holding the Fuse token can run a node]() that approves transaction in the network and in doing so receive rewards in the form of Fuse token \(FUSE\).
